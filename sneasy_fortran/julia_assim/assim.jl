...
function construct_log_post(endyear=2010; assim_temp=true, assim_ocheat=true, assim_co2inst=true, assim_co2ice=true, assim_ocflux=false)
    ...
    function sneays_log_lik(p)
        ...
        #LOOKS LIKE THIS WORKS, JUS TDOUBLECHECK
        ##
        #
        #
        #
