@defcomp rfco2 begin
    ...
    scale_CO₂ = Parameter(default=1.0) #Scaling factor to ensure "Tune the coefficient of CO2 forcing to acheive desired F2x, using # pre-industrial CO2 and N2O FOLLOWING FAIR APPROACH
